...
var _formatWebpackMessages = _interopRequireDefault(require("../dev/error-overlay/format-webpack-messages"));
var _hooksClient = require("./hooks-client");
function HotReload({ assetPrefix  }) {
    const { tree  } = (0, _react).useContext(_appRouterContext.FullAppTreeContext);
    ...
    (0, _react).useEffect(()=>{
        const handler = (event)=>{
            if (event.data.indexOf('action') === -1 && // TODO: clean this up for consistency
